...
df.classied <- flagOutliers(df.ranked.quantile,threshold)

```

```{r run package code}

reg_estimates <- DHSTopLevelAnalysis(df.classied, 
...
DHSTopLevelPlots(reg_estimates,df.classied)
