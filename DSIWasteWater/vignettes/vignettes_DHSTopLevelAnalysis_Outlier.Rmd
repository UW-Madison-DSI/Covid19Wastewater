...
---
title: "DHS analysis comparing the base analysis to outlier Filtering"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{DHS analysis comparing the base analysis to outlier Filtering}
...
```{r make DHS plot, fig.height=7.5,fig.width=38}
