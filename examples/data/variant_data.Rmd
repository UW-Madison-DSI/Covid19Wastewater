...
### Data
This data is from https://github.com/hodcroftlab/covariants/tree/master Credit to: Emma B. Hodcroft. 2021. "CoVariants: SARS-CoV-2 Mutations and Variants of Interest." https://covariants.org/ 

This data reports the proportion of cases that are each variant every 2 weeks for the state of Wisconsin(and every state).
