...
library(ggplot2)
library(dplyr)
#takes a ggplot object and add the vertical flags


#define color scheme for the plots to have
colorScheme <- scale_color_manual(values = 
                                c("Cslope_switch_flag" = "red",
                                "flag_ntile" = "blue",
                                "Both" = "green",
...
#add love version of Case data for easier comparison
Raw_Plot_DF$log.FirstConfirmed.Per100K <- log(Raw_Plot_DF$FirstConfirmed.Per100K)
#also divide log.sum.casesperday.Per100K by 7 to make is a daily average instead of a sum
