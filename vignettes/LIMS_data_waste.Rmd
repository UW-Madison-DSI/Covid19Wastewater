...
date: "2023-06-15"
vignette: >
  %\VignetteIndexEntry{LIMS Waste Data}
...
```
The data is broken down by site and data. Site is where it was collected from. The primary column is N1 and N2 which are two different genes of Covid-19. 
