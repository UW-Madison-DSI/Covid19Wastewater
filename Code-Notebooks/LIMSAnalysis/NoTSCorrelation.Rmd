...
CheckFunction(DaySmoothing=c(7,14),Show2=FALSE,Mat=TRUE,Ret="PVal",CasesUsed="Cases4")
```
...
HeatMapCor(c(7),CasesUsed="Cases4")
HeatMapCor(c(7),CasesUsed="CasesM")
HeatMapCor(c(7,14),DateStart=mdy("4/10/2020"))

plot(es(MergedDF$N1,phi =.5)$fitted)
```