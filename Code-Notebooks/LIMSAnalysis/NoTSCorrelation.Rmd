...
print("Binning -> SLD")
HeatMapCor(StartDate=0:7,DaySmoothing=c(7),Lag=-2:2,CasesUsed="Cases4")
print("SLD->Binning")
HeatMapCor(StartDate=0:7,DaySmoothing=c(7),Lag=-2:2,CasesUsed="CasesM")
print("Binning -> SLD late Start")
HeatMapCor(StartDate=0:7,DaySmoothing=c(7),Lag=-2:2,CasesUsed="CasesM",DateStart=mdy("11/13/2020"),ShowPlots=FALSE)
