...
#TS Framework. Want var

#Look at other trend finders that predict
#TS smoothing that mimics loess

#1) SLD loess - interceptors agree - complex
#2) Binning regression - simple clear relationship - simple
#AC is throwing off binning a bit-look at every other week?-try to remove AC
#Two good heuristics
#3)Use TS to fit model=-ma(1)-ar(inf) 7 day MA or longer
#this is underlying reason
#shows there is a signal

#could be a paper:could be many other questions
#train on subsection->predict other
#try on other locations
#look at pop
#how to get cases from N1->know how to get cases
#SLD->Cases
