...
#waiting on updated hfd to do rigorous variance analysis
#
#weekly fluctuations
#AR PACF version of CCF
#unweekend the effect
#weekend effect means
#Model weekend effect on individual data then subtract it
#ccf of data with presmoothings
#Retry on smoothed data

#PACF account for changing mean
#Pre
#dif()
```
...
#outliers might cause correlation spikiness

#7 day bins
#7 day rolling average
#regression prediction
#some way to remove day of week effect


#N1 ccf with step function 7 days
#ccf with weekly effect
#seasonality
#season vs spiking
#desecrate seasonality?
#More research

#need to do more then first step
#show clear day of week effect
#Start simple-find best simple model-no normalizing-find issue, try to fix it-read or find hack, should give similar answers
#ccf between cases and %Pos
#looking for something to grab-place to grow from
