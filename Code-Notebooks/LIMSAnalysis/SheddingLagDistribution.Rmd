...
dgamma(1:21,scale =5.028338,shape =2.332779)
```
...
#   geom_point()+
#   labs(x="SLD Cases")+
#   annotate("text", x=300, y=4e4, label= paste("R^2:", signif(summary(lm((Cases2.PreRolled)~(lead(N1Filtered,LeadN)),data=MergedDF))[[8]],3)))+
...
# 
# summary(lm((Cases2.PreRolled)~(lead(N1,LeadN)),data=MergedDF))
# summary(lm((Cases2.PreRolled)~(lead(N1Filtered,LeadN)),data=MergedDF))
# summary(lm(CasesM~N1M,data=MadData))
# summary(lm(Cases2.PreRolled~lead(LoessN1,14),data=MergedDF))
```
