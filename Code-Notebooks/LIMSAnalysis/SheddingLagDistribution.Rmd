...
MergedDF$LoessN1 <- DFLoessFNC(MergedDF,Var="N1",SiteS="Madison",span=.2)
MergedDF$LoessN2 <- DFLoessFNC(MergedDF,Var="N2",SiteS="Madison",span=.2)
...
ccf(diff((loessN1Vec)),diff(log(SLDPreRolledVec)))

A <- ts.union(diff(log(SLDPreRolledVec)),
                diff(stats::lag((loessN1Vec),4)))
summary(lm(A[,1]~A[,2]))
