...
DFSmoothingDormsFNC <- function(CaseDF,SiteS){
  #5.028338
  scale =5.028338
  #2.332779
  shape =2.332779
...
```{r 6 part plot}
#(SourceDF$N1Error)
TSPloting <- function(PlotingTS,SourceDF,SubTitle,SLD=TRUE){
  if(SLD){
    Shade <- 0.5
    Thickness <- 1
  }else{
...
TSPloting(list(SLDCaseVec,loessN1Vec,CaseVec),MergedDF,
...
#loess
#Cases with MA
#bring in SLD with everything
#include span in legend? in small font


#How to communicate clearly
#read paper to see if transformation is pos
#mess with N1 y to see if it looks better. low prio
#MA Key
#look at convolution of MA SLD
```
