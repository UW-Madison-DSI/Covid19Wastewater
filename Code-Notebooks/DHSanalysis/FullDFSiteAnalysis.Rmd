...
Catagorylabel = c("major decrease","moderate decrease","fluctuating ","moderate increase","major increase")
  ...
  reg_estimates <- FactorVecByNumPoints(reg_estimates,"WWTP","modeled_percentchange")%>%
    mutate(Catagory = cut(modeled_percentchange,c(-Inf,-80,-10,10,100,Inf),
                          labels = Catagorylabel,include.lowest=TRUE,
                          ordered_result=TRUE))
...
HeatMapPlotSave(BaseMod,"Catagory", "RecPatternRaw.pdf")
...
HeatMapPlotSave(LoessMod,"Catagory", "RecPatternLoess.pdf")
...
ggsave("Temp.PDF",plot=SavePlot,
         width = 16*Dim,height = 15,units="cm",limitsize =FALSE)
