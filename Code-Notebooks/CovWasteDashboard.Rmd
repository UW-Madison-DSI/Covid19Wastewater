             ...
             fluidRow(
               jqui_resizable(box(width=4,
                                  ...
                                  conditionalPanel(
                                    ...
                                    sliderInput("Offset2", "Shift cases Date",min = maxLeftShif, max = maxRightShift,step=1,value=0)
                                  ),
                                  conditionalPanel(
             ...
             fluidRow(
               jqui_resizable(box(width=4,
                                  ...
                                  conditionalPanel(
                                    ...
                                    sliderInput("Offset", "Shift percent positive Date",min = maxLeftShif, max = maxRightShift,step=1,value=0)
                                  ),
                                  conditionalPanel(
