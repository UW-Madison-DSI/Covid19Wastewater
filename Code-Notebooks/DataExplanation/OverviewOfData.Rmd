...
MainHFGCaseDF%>%
  ggplot()+
  aes(x=Date)+
  geom_point(aes(y=ReportedCases,color="ReportedCases"),size=1)+
  geom_point(aes(y=EpisodeCases,color="EpisodeCases"),size=1)+
  geom_point(aes(y=CollectedCases,color="CollectedCases"),size=1)+
  geom_point(aes(y=ConfirmedCases,color="ConfirmedCases"),size=1)+
