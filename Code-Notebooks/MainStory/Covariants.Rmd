...
ModelDF <- FullDF%>%
    ...
    mutate(TrendError = abs(N1-loessN1))
...
#regressor <- randomForest(TrendError ~ . , data= ModelDF, 
#                          importance=TRUE, na.action = na.pass) # fit the random forest with default parameter
