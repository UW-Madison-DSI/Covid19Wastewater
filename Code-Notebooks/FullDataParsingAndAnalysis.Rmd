...
a=AllDataDF%>%
  ...
  geom_rect(aes(ymin=N1-2*N1Error,ymax=N1+2*N1Error,xmin=Date-1,xmax=Date+1),fill="light blue",color="Black",alpha=.5)+
  geom_rect(aes(ymin=N1,ymax=N1,xmin=Date-1,xmax=Date+1),fill="red",color="Black",alpha=.5)+
  geom_smooth(aes(x=Date,y=N1),span=.42,se=FALSE)+
  scale_y_log10(limits=c(1e3,5e6))+
  #scale_x_date(limits=c(N1Start,N1End))+
  facet_wrap(~Site,scales = "free_y")+
  ggtitle("4 largest citys with 2 SE bounds")+ 
