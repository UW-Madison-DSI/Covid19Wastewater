...
Clear linear relationship between N1 and its varience
...
HFGFrame%>%
  ...
  ggplot()+geom_point(aes(x=mN1,y=sqrt(vN1),color=Site))+scale_y_log10()+scale_x_log10()
...
LM=lm(data=HFGVar,sqrt(vN1)~mN1)
...
ggplot()+
  ...
  scale_y_log10()+
  scale_x_date(limits=c(N1Start,N1End))+ggtitle("HFG, Longitudinal data and predicted intervels")
