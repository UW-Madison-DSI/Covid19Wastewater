...
HFGWasteFN <-  paste0(BaseDir,"COVID-19_WastewaterAnalysis/data/processed/UpdatedHFGFN.csv")
...
HFGDF <- ParseData(HFGWasteFN)%>%#reads HFG data in
...
CompCaseHFGDF <- HFGCaseDF%>%
  #mutate(ReportedCases = ifelse(ReportedCases == -999, 2.5, #ReportedCases))%>%
