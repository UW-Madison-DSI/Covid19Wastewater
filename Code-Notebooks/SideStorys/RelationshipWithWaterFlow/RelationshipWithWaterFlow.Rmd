...
On a first past population can be used for three purposes.

1) Normalize data across sites.

2) Normalize data within sites

The below show that it is largly useless to use flow to normalize across site because it so strongly correlates with population.
...
LIMSFullDF%>%
  ...
  ggtitle("Nearly Perfect linear relation between N1 and Flowrate")
```