...
annotate_figure(WWTPBoxPlot,bottom = text_grob(paste("PVal=",format(PRWWTP,digits=3))))
...
annotate_figure(WWTPBoxPlot,bottom = text_grob(paste("PVal=",format(PRWWTPFilter,digits=3))))
...
MixedEffectModelPlot <- function(DF,Title){
  ...
  annotate_figure(MainPlot,
      bottom = text_grob(paste("PVal of Time:",
