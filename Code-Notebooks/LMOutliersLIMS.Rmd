...
MadBoxPlot=ggplot()+
  ...
  geom_smooth(aes(x=Date,y=N1,color="SD", weight=1/(N1Error)),span=.33,se=errorband,data=MadLIMSData)+
  geom_smooth(aes(x=Date,y=N1,color="Var", weight=1/(N1Error)^2),span=.33,se=errorband,data=MadLIMSData)+
