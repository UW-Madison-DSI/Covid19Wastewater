...
```{r PMMoV, warning=FALSE, fig.width=15,fig.height=18,echo=FALSE}

#PMMoV and Percent Bovine Recovery are still unclear use.
...
#   filter(Site==Sites)%>%
#   ggplot()+
#   aes(x=Date,color=PMMoV)+
#   #scale_colour_viridis_b()+
#   geom_point(aes(y=N1,color="N1"))+
#   geom_point(aes(y=.005*PMMoV,color="PMMoV"))+
#   scale_y_log10()+
#   facet_wrap(~Site)
# }


# LoessSmoothPlot("Madison")
