...
N1CaseCompDorms <- function(SiteS){
  ...
  FallRange=c(MinConc,mdy("12/21/2020"))
  SpringRange=c(mdy("1/15/2021"),MaxConc)
...
No clear use for %BCov and PMMOV. Below shows that unusual PMMoV and BCoV do not seem to relate to unusual N1 values.
