...
```{r SE Pred N1 Extra, fig.height = 12, fig.width = 12, include=FALSE}
...
annotate_figure(ggarrange(G1,G2,G3,G4,G5,G6, common.legend = T),top = text_grob("Weighted loess smoothing with truncation
